...
\begin{tabular}{p{2.3cm}p{4.4cm}p{4.4cm}p{4.4cm}p{3.5cm}p{3.5cm}p{3.5cm}p{3.5cm}}
\toprule
& \multicolumn{3}{c}{\textbf{OECD ILSAs}} & \multicolumn{4}{c}{\textbf{IEA ILSAs}} \\
\cmidrule(lr){2-4}\cmidrule(lr){5-8}
Feature & PISA & TALIS & PIAAC & TIMSS & PIRLS & ICCS & ICILS \\
\midrule
...
& Working conditions, teaching practices, professional development
...
Administration Mode
& CBA as primary mode since 2015; fully digital since 2018
& CBA adopted as default for 2024; paper-based in 2008 and 2013
& CBA as primary mode since 2022--23; paper-based retained for limited-access participants in earlier cycles
& New items developed exclusively in CBA format since 2019; fully CBA in 2023
& CBA adopted as primary mode in 2021
& CBA offered as an option since 2022; bridging studies conducted to monitor mode effects
& Fully CBA since its first cycle in 2013 \\

Psychometric Model
& 2PL for dichotomous and Generalized PCM for polytomous items since 2015; MSAT routing introduced in reading in 2018
& CFA and multi-group CFA for construct validity; IRT used in a supplementary capacity since 2018
& IRT-based calibration on a common scale; MSAT fully integrated in 2022--23
& IRT and PVs since 1995; 2PL for new items, 3PL retained for trend items in 2023
& Scale continuity maintained across cycles; population-based linking adopted in 2021 to balance CBA--PBA differences
& High measurement invariance maintained between PBA and CBA from 2016 to 2022
& IRT proficiency estimates combined with latent regression information since 2013 \\

Scoring Approach
& Machine-Supported Coding for standard responses since 2022; human coding retained for complex open-ended items
& Automated scoring and quality control via online platform; pedagogical knowledge items scored since 2024 (TKS module)
& Automated scoring expanded with adaptive problem-solving tasks since 2022--23
& AI-assisted quality control and automated structured responses since 2023; hybrid scoring in earlier cycles
& Automated scoring expanded with CBA-suitable item types since 2021; human scoring retained for open-ended items
& Automated scoring introduced for interactive CBA tasks in 2022; human scoring retained for open-ended responses
& Hybrid from outset: automated for simulation and coding tasks, human for higher-order items \\
